                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="UpdateControl">
                            <!-- Form Group (username)-->
                            <input type="hidden" value="<%=p.getIdPro()%>" name="idProduct">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div>
                                    <label class="small mb-1" for="inputDetail">Mô tả</label>
                                    <input class="form-control"
                                           name="detailPro"
                                           id="inputDetail" type="text"
                                           placeholder="Nhập mô tả" value="<%=p.getDetailPro()%>">
                                </div>
                            </div>
                            <!-- Form Row-->
                            <!-- Save changes button-->
                            <button class="btn btn-primary" type="button"> <a href="">Lưu thông tin</a>
                            </button>
